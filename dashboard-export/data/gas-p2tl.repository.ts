import type { P2TLTarget, P2TLRealization, P2TLResponse, P2TLGantiMeterResponse, P2TLGantiMeterRecord, GantiMeterParams, LogsQueryParams, P2TLLogsResponse } from '../core/report.entity';
...
export class GasP2TLRepository {
