...
import type { P2TLTarget, P2TLRealization, P2TLResponse } from '../core/report.entity';
import { GasP2TLRepository } from '../data/gas-p2tl.repository';
import { formatIndoNumber, getIndonesianDateString } from '../core/generate-report.usecase';
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className={`p-5 ${colors.card} ${borderRadius.xl} border ${colors.border} flex items-center justify-between`}>
              <div className="space-y-1">
                ...
                <div className="text-xl font-black text-slate-800 dark:text-slate-55"> {formatIndoNumber(relHarian)} kWh</div>
            ...
            <div className={`p-5 ${colors.card} ${borderRadius.xl} border ${colors.border} flex items-center justify-between`}>
              <div className="space-y-1">
                ...
                <div className="text-xl font-black text-slate-800 dark:text-slate-55">{formatIndoNumber(relBulan)} kWh</div>
            ...
            <div className={`p-5 ${colors.card} ${borderRadius.xl} border ${colors.border} flex items-center justify-between`}>
              <div className="space-y-1">
                ...
                <div className="text-xl font-black text-slate-800 dark:text-slate-55">{formatIndoNumber(realSemester)} kWh</div>
            ...
            <div className={`p-5 ${colors.card} ${borderRadius.xl} border ${colors.border} flex items-center justify-between`}>
              <div className="space-y-1">
                ...
                <div className="text-xl font-black text-slate-800 dark:text-slate-55">{formatIndoNumber(relKumulatif)} kWh</div>
                  ...
                  if (activeDataset.length === 0) {
                    return (
                      <div className="flex flex-col items-center justify-center text-center p-6 bg-slate-50/50 dark:bg-slate-950/20 border border-slate-200/60 dark:border-slate-800/40 rounded-xl space-y-3 my-4">
                        ...
                        <div className="text-[11px] text-slate-400 dark:text-slate-500 max-w-xs leading-relaxed">
                      ...
                      <div className="sm:col-span-6 flex justify-center w-full">
                        <div className="relative w-48 h-48">
                          ...
                          <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                            <span className="text-3xl font-black text-slate-850 dark:text-slate-105 leading-none">
                              {totalCases}
                            </span>
                          ...
                          <div key={idx} className="flex items-center justify-between border-b border-slate-100 dark:border-slate-850/60 pb-1.5 last:border-0 last:pb-0">
                            <div className="flex items-center gap-2 min-w-0">
                              ...
                              <div className="min-w-0">
                                <div className="text-[11px] font-bold text-slate-705 dark:text-slate-350 truncate">
            ...
            <div className={`p-6 ${colors.card} ${borderRadius.xxl} border ${colors.border} ${shadows.md} flex flex-col relative`}>
                      ...
                      {Array.from({ length: 5 }).map((_, i) => {
                        ...
                        return (
                          <g key={i}>
                            ...
                            <text x="38" y={yVal + 3} textAnchor="end" className="text-[8px] font-bold text-slate-400 dark:text-slate-550">
              ...
              {hoveredMonth !== null && currentChartData[hoveredMonth] && (
                ...
                >
                  ...
                  <div className="text-[10px] text-slate-400">Kasus: <span className="font-bold text-slate-205">{currentChartData[hoveredMonth].cases} Kasus</span></div>
                </div>
              )}
            </div>
        ...
        <div className="space-y-6">
            ...
            <div className="flex-1 space-y-4 z-10 flex flex-col justify-between">
              ...
              <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-200/60 dark:border-slate-800/60">
                <div className="space-y-1">
                  ...
                  <div className="text-sm font-black text-slate-900 dark:text-slate-55">{formatIndoNumber(totalRealYear)} <span className="text-[10px] text-slate-505 font-semibold">kWh</span></div>
                </div>
                <div className="space-y-1 border-l border-slate-200 dark:border-slate-800 pl-4">
                  ...
                  <div className="text-sm font-black text-slate-900 dark:text-slate-55">{formatIndoNumber(targetKumulatifYtd)} <span className="text-[10px] text-slate-505 font-semibold">kWh</span></div>
                </div>
                <div className="space-y-1 border-l border-slate-200 dark:border-slate-800 pl-4">
                  <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Target Tahunan</div>
                  <div className="text-sm font-black text-slate-900 dark:text-slate-55">{formatIndoNumber(totalTargetYear)} <span className="text-[10px] text-slate-505 font-semibold">kWh</span></div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className={`p-5 ${colors.card} ${borderRadius.xxl} border ${colors.border} ${shadows.md} space-y-2`}>
              ...
              <div className="text-xl font-black text-slate-900 dark:text-slate-55">{formatIndoNumber(rataRataDibutuhkan)} <span className="text-xs font-bold text-slate-400">kWh</span></div>
              <div className="text-[10px] text-slate-400 font-semibold">
            ...
            <div className={`p-5 ${colors.card} ${borderRadius.xxl} border ${colors.border} ${shadows.md} space-y-2`}>
              ...
              {worstMonth ? (
                <>
                  <div className="text-xl font-black text-rose-505 dark:text-rose-400">{worstMonth.month}</div>
                  <div className="text-[10px] text-slate-400 font-semibold">
              ...
              <div className="p-4 bg-slate-50/40 dark:bg-slate-950/30 border border-slate-200/50 dark:border-slate-800/50 rounded-xl space-y-3 flex flex-col justify-between">
                ...
                <div className="pt-2 border-t border-slate-250/20 dark:border-slate-800/60 text-[10px] font-bold text-slate-450 dark:text-slate-400 space-y-1">
                  <div className="flex justify-between">
                    ...
                    <span className="text-slate-700 dark:text-slate-202 font-extrabold">{formatIndoNumber(Math.round(avgRealKwh))} kWh/bln</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Kebutuhan Bulanan:</span>
                    <span className="text-slate-700 dark:text-slate-202 font-extrabold">{formatIndoNumber(avgRequiredKwhCurrent)} kWh/bln</span>
                  </div>
                </div>
              ...
              <div className="p-4 bg-slate-50/40 dark:bg-slate-950/30 border border-slate-200/50 dark:border-slate-800/50 rounded-xl space-y-3 flex flex-col justify-between">
                ...
                <div className="pt-2 border-t border-slate-250/20 dark:border-slate-800/60 text-[10px] font-bold text-slate-450 dark:text-slate-400 space-y-1">
                  <div className="flex justify-between">
                    ...
                    <span className="text-slate-700 dark:text-slate-202 font-extrabold">{formatIndoNumber(baselineTargetHarian)} kWh/hari</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Target Harian Baru:</span>
                    <span className="text-slate-700 dark:text-slate-202 font-extrabold">{formatIndoNumber(newTargetHarian)} kWh/hari</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Kebutuhan Bulanan:</span>
                    <span className="text-slate-700 dark:text-slate-202 font-extrabold">{formatIndoNumber(avgRequiredKwhCurrent)} kWh/bln</span>
              ...
              <div className="p-4 bg-slate-50/40 dark:bg-slate-950/30 border border-slate-200/50 dark:border-slate-800/50 rounded-xl space-y-3 flex flex-col justify-between">
                ...
                <div className="pt-2 border-t border-slate-250/20 dark:border-slate-800/60 text-[10px] font-bold text-slate-450 dark:text-slate-400 space-y-1">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-slate-700 dark:text-slate-202 font-extrabold">{formatIndoNumber(avgRequiredKwh110)} kWh/bln</span>
                  </div>
                </div>
