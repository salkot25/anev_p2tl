          ...
          {[
            ...
            return (
              <div 
                key={idx} 
                onClick={s.onClick}
                className={`bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/85 rounded-2xl p-3 sm:p-5 flex flex-col justify-between shadow-sm transition-all duration-200 ${
                  isClickable 
