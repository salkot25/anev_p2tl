  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-[-20%] right-[-10%] w-[400px] h-[400px] bg-indigo-650/15 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-sm w-full relative z-10 animate-fade-in-up">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-7">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && (
              <div className="flex items-center gap-2 text-rose-600 bg-rose-50 border border-rose-100 px-3 py-2.5 rounded-xl text-xs font-semibold animate-fade-in dark:text-rose-650">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center items-center gap-2 py-3 px-4 rounded-xl text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 active:scale-[0.98] transition-all disabled:opacity-70 shadow-lg shadow-blue-650/30 mt-2 cursor-pointer"
            >
